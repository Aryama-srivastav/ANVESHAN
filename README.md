...
This repository provides a React + TypeScript + Vite interface for managing cases, documents, uploads, verification checks, audit trails, and permissioned ledger activity.
...
- **Authentication & RBAC:** Supabase authentication with role-based access control (Investigator, Legal Officer, Auditor, Admin).
- **Cases & Documents:** Case evidence filing, document management, and detail views.
- **Evidence Integrity:** SHA-256 cryptographic hashing and verification engine.
- **Chain of Custody & Audit:** Tamper-evident ledger, chronological custody log, and access tracking.
- **Sharing & Verification:** Permissioned case sharing and public/court verification portal.
