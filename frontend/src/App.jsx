    ...
    <div className="app-shell"><PrototypeBanner />
      ...
      <main className="main-content">
        ...
        <div className="page-wrap">
          ...
          {activeView === "access" && <Access grants={grants} canManage={canAdmin} onNewGrant={() => setModal("grant")} onOpenGrant={(grant) => setModal({ type: "grantDetail", grant })} />}
